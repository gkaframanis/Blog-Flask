...
# CONNECT TO DB
# "DATABASE_URL" we get it from heroku
...
# Create the admin_only decorator
...
# User table: One to many relationship with BlogPost and Comment tables
...
# BlogPost Table: One to Many relationship with Comment table.
    ...
    if request.method == "POST":
        if register_form.validate_on_submit():
            ...
            new_user = User(
                ...
                password=generate_password_hash(register_form.data["password"], "pbkdf2:sha256", salt_length=8),
